...
training_dirname = os.path.join(caffe_dirname, 'data/furniture')
...
if __name__ == '__main__':
    ...
    csv_filename = 'lounge_chair.csv' #os.path.join(example_dirname, 'flickr_style.csv.gz') 
...
#df = pd.read_csv(csv_filename, index_col=None, compression='gzip')
    ...
    df['image_filename'] = [
        os.path.join(images_dirname, _.split('/')[-1]) for _ in df['image_name']
    ]
